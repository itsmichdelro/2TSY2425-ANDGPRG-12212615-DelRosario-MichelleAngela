...
public class UIHandler : MonoBehaviour
{
    ...
    [SerializeField] private GameObject maxTierWarningUI;
    ...
    private void Start()
    {
        ...
        maxTierWarningUI.SetActive(false);
    }
    ...
    #region Upgrade Info
    public void ShowUpgradeInfo(Tier tierNumber)
    {
        HideTowerInfo();
        upgradeUI.SetActive(true);

        if (tierNumber == Tier.One)
        {
            upgradeInfoText.text = "UPGRADE 1 > 2" +
                "\nPrice: 100 gold" +
                "\nDamage: +3" +
                "\nFire rate: +1" +
                "\nRange: +1";
        ...
        {
            upgradeInfoText.text = "UPGRADE 2 > 3" +
                "\nPrice: 250" +
                "\nDamage: +5" +
                "\nFire rate: +2" +
                "\nRange: +2";
        ...
        {
            upgradeUI.SetActive(false);
            maxTierWarningUI.SetActive(true);
        }
    }
    ...
    {
        HideTowerInfo();
        UpgradeManager.Instance.SelectTower();
    }

    public void ProceedUpgradeButton()
    {
        if (PlayerManager.Instance.GetGoldAmount >= UpgradeManager.Instance.GetUpgradeCost)
        {
            HideUpgradeInfo();
        ...
        if (PlayerManager.Instance.GetGoldAmount < UpgradeManager.Instance.GetUpgradeCost)
        {
            upgradeInfoText.text = "Not enough gold!";
        }
    }
    ...
    {
        HideUpgradeInfo();
        UpgradeManager.Instance.CancelSelectTower();
    }
    #endregion
